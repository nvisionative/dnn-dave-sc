...
*/
public class DnnSearch : Custom.Hybrid.Code12, ICustomizeSearch
{
    /// <summary>
    /// Populate the search
    /// </summary>
    ...
    public void CustomizeSearch(Dictionary<string, List<ISearchItem>> searchInfos, IModule moduleInfo, DateTime beginDate)
    {
        ...
        foreach (var si in searchInfos["Default"])
        {
            ...
            Log.Add("Title: " + si.Title);
            si.QueryString = "video/episode/" + entity.Slug;
            Log.Add("QueryString: " + si.QueryString);
        }
